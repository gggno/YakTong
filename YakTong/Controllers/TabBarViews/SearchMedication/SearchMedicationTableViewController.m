#import "SearchMedicationTableViewController.h"

@interface SearchMedicationTableViewController ()
{
...
@implementation SearchMedicationTableViewController
...
- (void)initialSetting
{
    ...
    [_searchTableView registerNib:searchMediCellNib forCellReuseIdentifier:@"SearchMediTableViewCell"];
